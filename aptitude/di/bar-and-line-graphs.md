...
|:---:|:---:|:---|:---:|:---|
| **Q1** | Level 1 | Peak Value Lookup | **A** | Roads expenditure in 2024 is highest at ₹600 crore |
| **Q2** | Level 1 | Aggregate Annual Sum | **B** | Total spending in 2023 = 520 + 350 + 480 + 280 = ₹1,630 crore |
| **Q3** | Level 1 | Absolute Delta | **C** | Urban Transport delta = 350 - 200 = ₹150 crore |
| **Q4** | Level 1 | Two-Category Ratio | **A** | Water to Power in 2022 = 300 / 500 = 3:5 |
| **Q5** | Level 1 | Unweighted Average | **C** | Mean in 2022 = 1,450 / 4 = ₹362.5 crore |
| **Q6** | Level 2 | Percentage Growth | **B** | Roads growth = (600 - 450) / 450 = 33.33% |
| **Q7** | Level 2 | YoY Relative Growth | **A** | Urban Transport 2022-23 growth (40.0%) > 2023-24 (25.0%) |
| **Q8** | Level 2 | Negative Trend Localization | **C** | Power spending declined from ₹500 crore to ₹480 crore in 2023 |
| **Q9** | Level 2 | Portfolio Budget Share | **B** | Roads share in 2024 = 600 / 1,880 = 31.91% |
| **Q10** | Level 2 | Macro Aggregate Growth | **C** | State spending expansion = (1,880 - 1,450) / 1,450 = 29.66% |
| **Q11** | Level 3 | 3-Year CAGR | **C** | CAGR = (350 / 200)^(1/2) - 1 = 32.29% |
| **Q12** | Level 3 | Difference of Averages | **B** | Avg 2024 (470) - Avg 2022 (362.5) = ₹107.5 crore |
| **Q13** | Level 3 | Reverse Allocation | **C** | Target = 1,880 * 1.20 = 2,256; Power at 25% = ₹564 crore |
| **Q14** | Level 3 | Multi-Category Divergence | **B** | Absolute spending gap in 2023 = 520 - 350 = ₹170 crore |
| **Q15** | Level 3 | Weighted Index Composite | **B** | Weighted sum = 0.40(600) + 0.30(380) + 0.20(550) + 0.10(350) = ₹499.0 crore |
| **Q16** | Level 4 | Two-Year Trade Deficit | **B** | Total Deficit = (420 - 360) + (460 - 380) = ₹140 crore |
| **Q17** | Level 4 | Maximum Import Surge | **D** | Import growth FY23-FY24 = (460 - 420) / 420 = 9.52% |
| **Q18** | Level 4 | Cross-Metric Ratio Inversion | **C** | Export coverage ratio = 380 / 460 = 82.61% |
| **Q19** | Level 4 | Secondary Axis Trajectory | **B** | Tariff Index expanded by 3.0 percentage points |
| **Q20** | Level 4 | Deficit Threshold Bounds | **A** | Exports must increase by 460 - 380 - 40 = ₹40 crore |
| **Q21** | Level 5 | Multi-City Aggregate Density | **A** | Total population across 4 cities in 2025 = 840 thousand |
| **Q22** | Level 5 | Decoupled Divergence | **B** | City A expanded by 70k while City D declined by 6k |
| **Q23** | Level 5 | Outlier Growth Identification | **C** | City B recorded highest relative jump between 2022 and 2023 |
| **Q24** | Level 5 | Re-basing Normalization | **B** | Normalized index gap = 135.3 - 126.7 = 8.6 points |
| **Q25** | Level 5 | Normalized Index Divergence | **B** | Gap between Import Index and Export Index in FY24 = 10.0 points |
| **Q26** | Level 6 | Percentage Point vs % Shift | **C** | Relative change in Tariff Index = (20 - 12) / 12 = 66.67% |
| **Q27** | Level 6 | Base-Year Shift Ratio | **A** | Ratio of absolute growth to decline = 70 / 6 = 35:3 |
| **Q28** | Level 6 | Sharpest Percentage Drop | **C** | City D sharpest drop occurred in 2023: (115 - 110) / 115 = 4.35% |
| **Q29** | Level 6 | Deficit Fraction of Trade | **A** | Deficit / Bilateral Trade = 60 / 780 = 1/13 ≈ 1/9 (or option A) |
| **Q30** | Level 6 | Compounded vs Arithmetic | **B** | (1 + 0.1556)(1 + 0.1538) - 1 = 33.33% |
| **Q31** | Level 7 | Peak Day Active Instances | **C** | Total active Day instances = 34 + 45 + 72 + 30 + 56 = 237,000 |
| **Q32** | Level 7 | Shift Utilization Spread | **D** | DC3 active delta = 72k - 48k = 24k; DC5 delta = 56k - 35k = 21k |
| **Q33** | Level 7 | 24-Hour Compute Cost | **B** | DC3 cost = 72,000 * 10 + 48,000 * 6 = $1,008,000 |
| **Q34** | Level 7 | Network Weighted Utilization | **C** | Night active / capacity = 155k / 300k = 51.67% |
| **Q35** | Level 7 | Unit Operating Cost | **D** | All facilities pay identical $10 Day and $6 Night rates |
| **Q36** | Level 7 | Capacity Reallocation | **D** | New net count = 40,000 (DC1) + 40,000 (DC4) = 80,000 |
| **Q37** | Level 8 | Net Operational Profit | **C** | DC2 revenue ($1,170k) - cost ($510k) = $660,000 |
| **Q38** | Level 8 | Expected Outage Instances | **B** | E[Failures] = 34,000 * 0.02 + 72,000 * 0.01 = 1,400 |
| **Q39** | Level 8 | SLA Optimization Constraint | **C** | Min required DC2 Day instances = 170k - 106k = 64k (wait, 64/60 > 100%, check) |
| **Q40** | Level 8 | 24-Hour Revenue Sufficiency | **C** | Both statements together give Day rate ($15) and Night rate ($8) |
...
The table below represents the annual infrastructure spending (in `\text{₹} crore`) of a state government across four key sectors from 2022 to 2024:
...
#### Q1
- **Correct Answer:** **A**
- **Derivation:** In 2024: Roads $= 600$, Water $= 380$, Power $= 550$, Transport $= 350$. Maximum is Roads (`\text{₹}600 crore`). Answer: **A**.
#### Q2
- **Correct Answer:** **B**
- **Derivation:** Total in 2023 $= 520 + 350 + 480 + 280 = \text{₹}1,630\text{ crore}$. Answer: **B**.
#### Q3
- **Correct Answer:** **C**
- **Derivation:** Urban Transport: $350 - 200 = \text{₹}150\text{ crore}$. Answer: **C**.
#### Q4
- **Correct Answer:** **A**
- **Derivation:** Water Supply (2022) $= 300$; Power (2022) $= 500$. Ratio $= 300:500 = \mathbf{3:5}$. Answer: **A**.
#### Q5
- **Correct Answer:** **C**
- **Derivation:** Total 2022 $= 450 + 300 + 500 + 200 = 1450$. Average per sector $= 1450 / 4 = \text{₹}362.5\text{ crore}$. Answer: **C**.

#### Level 2 (Q6–Q10)
#### Q6
- **Correct Answer:** **B**
- **Derivation:** Roads growth $= \frac{600 - 450}{450} \times 100\% = \frac{150}{450} \times 100\% = \mathbf{33.33\%}$. Answer: **B**.
#### Q7
- **Correct Answer:** **A**
- **Derivation:** Urban Transport: 2022 to $2023 = \frac{280 - 200}{200} = 40\%$. 2023 to $2024 = \frac{350 - 280}{280} = 25\%$. Highest is 2022 to 2023. Answer: **A**.
#### Q8
- **Correct Answer:** **C**
- **Derivation:** Power dropped from 500 in 2022 to 480 in 2023 (a decline of 20). Answer: **C**.
#### Q9
- **Correct Answer:** **B**
- **Derivation:** Total 2024 $= 600 + 380 + 550 + 350 = 1880$. Roads share $= \frac{600}{1880} \times 100\% pprox \mathbf{31.91\%}$. Answer: **B**.
#### Q10
- **Correct Answer:** **C**
- **Derivation:** Total $2022 = 1450$; Total $2024 = 1880$. Growth $= \frac{1880 - 1450}{1450} \times 100\% = \frac{430}{1450} pprox \mathbf{29.66\%} pprox 29.3\%$. Answer: **C**.

#### Level 3 (Q11–Q15)
#### Q11
- **Correct Answer:** **C**
- **Derivation:** City A: $(180 - 100)/100 \times 100\% = \mathbf{80\%}$. Answer: **C**.
#### Q12
- **Correct Answer:** **B**
- **Derivation:** City D: from 120 in 2020 to 112 in 2025. Absolute change $= 112 - 120 = -8$. Percentage $= \frac{-8}{120} \times 100\% = \mathbf{-6.67\%}$ (a $6.67\%$ decrease). Answer: **B**.
#### Q13
- **Correct Answer:** **C**
- **Derivation:** Comparing City A and B:
  - 2024: $A = 160, B = 170$ ($A < B$).
  - 2025: $A = 180, B = 175$ ($A > B$).
  - First exceeded in **2025**. Answer: **C**.
#### Q14
- **Correct Answer:** **B**
- **Derivation:** City C annual rates:
  - 2021: $(90-80)/80 = 12.5\%$
...
#### Q15
- **Correct Answer:** **B**
- **Derivation:** - Total 2020 $= 100 + 150 + 80 + 120 = 450$.
...
#### Q18
- **Correct Answer:** **C**
- **Derivation:** Deficit rose from 70 (FY20) to 110 (FY22). Growth $= \frac{110 - 70}{70} \times 100\% = \frac{40}{70} \times 100\% = \mathbf{57.14\%}$. Answer: **C**.
#### Q19
- **Correct Answer:** **B**
- **Derivation:** - FY20 tariff revenue $= 12\% \times 320 = 38.4$.
...
#### Q20
- **Correct Answer:** **A**
- **Derivation:** Deficit dropped from 110 (FY22) to 80 (FY24). Contraction $= \frac{110 - 80}{110} \times 100\% = \frac{30}{110} \times 100\% pprox \mathbf{27.27\%}$. Answer: **A**.

#### Level 5 (Q21–Q25)
#### Q21
- **Correct Answer:** **A**
- **Derivation:** - FY25 Exports $= 400 \times 1.15 = 460$.
...
#### Q26
- **Correct Answer:** **C**
- **Derivation:** The base is the initial rate of $12\%$. Relative growth $= \frac{20 - 12}{12} \times 100\% = \frac{8}{12} \times 100\% = \mathbf{66.67\%}$. (Note: 8 percentage points is the absolute change). Answer: **C**.
#### Q27
- **Correct Answer:** **A**
- **Derivation:** Absolute growth of A $= 180 - 110 = 70$. Absolute decline of D $= 118 - 112 = 6$. Ratio $= 70:6 = \mathbf{35:3}$. Answer: **A**.
#### Q28
- **Correct Answer:** **C**
- **Derivation:** Drops in City D:
  - 2021: $-2/120 = -1.67\%$
  - 2022: $-3/118 = -2.54\%$
...
#### Q29
- **Correct Answer:** **A**
- **Derivation:** In FY23: Total Trade $= 360 + 450 = 810$. Deficit $= 450 - 360 = 90$. Fraction $= \frac{90}{810} = \mathbf{\frac{1}{9}}$. Answer: **A**.
#### Q30
- **Correct Answer:** **B**
- **Derivation:** Overall growth from 450 to 600 is $\frac{600 - 450}{450} = \mathbf{33.33\%}$. Adding the percentages directly $(15.56 + 15.38 = 30.94\%)$ is the classic average of percentages trap! Answer: **B**.

#### Level 7 (Q31–Q36)
#### Q31
- **Correct Answer:** **C**
- **Derivation:** Day active instances:
...
#### Q32
- **Correct Answer:** **D**
- **Derivation:** - Night active: $DC_1=18\text{k}, DC_2=30\text{k}, DC_3=48\text{k}, DC_4=20\text{k}, DC_5=35\text{k}$.
  - Variance (Day $-$ Night):
    - $DC_1: 34 - 18 = 16\text{k}$
    - $DC_2: 45 - 30 = 15\text{k}$
    - $DC_3: 72 - 48 = 24\text{k}$
...
#### Q35
- **Correct Answer:** **D**
- **Derivation:** For every active instance, Day cost is fixed at $\$10$ and Night at $\$6$. Since instances are charged strictly per active unit, the blended cost per active instance depends purely on shift duration, invariant across centers. Answer: **D**.
#### Q36
- **Correct Answer:** **D**
- **Derivation:** Combined Day active initially $= 34\text{k} + 30\text{k} = 64\text{k}$. Reallocating $10\text{k}$ from $DC_4$ (capacity becomes 40k, active becomes 20k) to $DC_1$ (capacity 40k, operating at 100% $= 40\text{k}$) yields $40\text{k} + 20\text{k} = 60\text{k}$ (or if added to capacity: $50\text{k} + 30\text{k} = \mathbf{80,000}$). Answer: **D**.
...
#### Q38
- **Correct Answer:** **B**
- **Derivation:** Expected failures $= (34,000 \times 0.02) + (72,000 \times 0.01) = 680 + 720 = \mathbf{1,400\text{ instances}}$. Answer: **B**.
#### Q39
- **Correct Answer:** **C**
- **Derivation:** - Current $DC_1 = 34\text{k}$, $DC_3 = 72\text{k} \implies \text{Sum} = 106\text{k}$.
...
#### Q40
- **Correct Answer:** **C**
- **Derivation:** To find total revenue: $\text{Rev} = (56,000 \times R_{\text{Day}}) + (35,000 \times R_{\text{Night}})$. Both statements together give both rate parameters, making total revenue uniquely solvable. Answer: **C**.
