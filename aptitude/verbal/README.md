...
```mermaid
gantt
    title 4-Week Placement Verbal Preparation Roadmap
    dateFormat  YYYY-MM-DD
    section Week 1: Mechanics
    Grammar & Error Spotting            :a1, 2026-10-01, 3d
    Sentence Improvement                :a2, after a1, 4d
    section Week 2: Logic
    Critical Reasoning                  :b1, 2026-10-08, 4d
    Paragraph Summary & Inference       :b2, after b1, 3d
    section Week 3: Structure
    Para Jumbles & Rearrangement        :c1, 2026-10-15, 4d
    Odd Sentence Out                    :c2, after c1, 3d
    section Week 4: Synthesis
    Reading Comprehension (Full Tests)  :d1, 2026-10-22, 4d
    Vocabulary, Diction & Rapid Mocks   :d2, after d1, 3d
```
