...
│   └── gate/                          GATE Civil: notes, formulas, practice
│
├── non-core/                          ── Non-Technical Tracks ──
│   ├── consulting/                    Case frameworks, case bank
│   ├── data-analyst/                  DA overview, statistics
│   ├── business-analyst/              BA overview, SQL practice
│   ├── product-management/            PM overview, metrics, product sense
...
├── docs/                              Start here, control panel, roadmap
...
| [`docs/placement-control-panel.md`](docs/placement-control-panel.md) | Command center — all resources in one place |
