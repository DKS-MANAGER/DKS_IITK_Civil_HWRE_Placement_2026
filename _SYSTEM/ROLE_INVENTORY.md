# Role Inventory — Complete Repository Audit

> Auto-generated. Maps every role/profile in the repository to its study files, content depth, and priority tier.

---

## Tier A — Placement-Critical (Strong evidence / high company demand)
...
- **Interview Files:** ✅ Deep technical questions, follow-up chains
- **Roadmap:** ✅ Subject roadmaps in each file
- **Completeness:** STRONG (but needs role-level framing, study plan, rapid revision sheet)
...
- **Interview Files:** ✅ High-value questions
- **Roadmap:** ✅ Subject roadmaps
- **Completeness:** STRONG (needs role-level study plan, company mapping)
...
- **Interview Files:** ✅ Quick interview answers
- **Roadmap:** ✅ Cross-links
- **Completeness:** ADEQUATE (needs role-level study plan, PSU company mapping)
...
- **Interview Files:** ✅ Behavioral + consulting-specific
- **Roadmap:** ✅ Cross-links
- **Completeness:** ADEQUATE (needs rapid revision, mock test, deeper worked examples)
...
- **Interview Files:** ✅ Deep technical Q&A
- **Roadmap:** ✅ Cross-links
- **Completeness:** ADEQUATE (needs role-level framing, rapid revision)
...
- **Interview Files:** ✅ Deep technical Q&A
- **Roadmap:** ✅ Subject roadmaps
- **Completeness:** ADEQUATE (overlaps with Water Resources; needs role-level framing)
...
- **Interview Files:** ✅ Technical Q&A
- **Roadmap:** ✅ Cross-links
- **Completeness:** ADEQUATE (needs role-level study plan, PSU mapping)
...
- **Interview Files:** ✅ Technical Q&A
- **Roadmap:** ✅ Cross-links
- **Completeness:** ADEQUATE (needs role-level study plan, company mapping)
...
- **Interview Files:** ✅ Technical Q&A
- **Roadmap:** ✅ Cross-links
- **Completeness:** ADEQUATE (needs role-level study plan, behavioral prep)
...
## Tier B — Important Alternatives (Likely to be targeted)
...
- **Interview Files:** ✅ Scenario questions, behavioral
- **Roadmap:** ✅ Topic checklists
- **Completeness:** ADEQUATE (needs practice problems, worked examples, rapid revision, mock test)
...
- **Interview Files:** ✅ Technical Q&A
- **Roadmap:** ✅ Topic checklists
- **Completeness:** ADEQUATE (needs more SQL practice, worked examples)
...
- **Interview Files:** ✅ Technical Q&A
- **Roadmap:** ✅ Topic checklists
- **Completeness:** ADEQUATE (needs more practice, worked examples)
...
- **Completeness:** THIN (needs worked examples, more questions, interview prep)

---

## Tier C — Opportunistic (Lower-frequency but present in repository)
...
## Shared Resources (Used Across Roles)
...
| Tier | Roles | Status |
|:-----|:------|:-------|
| **Tier A (Placement-Critical)** | 10 roles | 8 STRONG, 2 ADEQUATE |
| **Tier B (Important Alternatives)** | 5 roles | 4 ADEQUATE, 1 THIN |
| **Tier C (Opportunistic)** | 10 roles | 10 THIN |
| **Total** | **25 roles** | **8 STRONG, 6 ADEQUATE, 11 THIN** |

---

## Key Gap: Role-Level Framing

Even STRONG roles are missing:
1. **ROLE_STUDY_PLAN.md** — No role has a dedicated study plan file
2. **ROLE_STUDY_MATERIAL.md** — No role has a consolidated study file
3. **ROLE_PRACTICE.md** — No role has a dedicated practice file
4. **ROLE_INTERVIEW.md** — No role has a dedicated interview prep file
5. **ROLE_RAPID_REVISION.md** — No role has a rapid revision sheet
6. **ROLE_MOCK_TEST.md** — No role has a mock test
7. **Company→Role Mapping** — Company profiles don't link back to role study plans

The core subject files are strong, but the **role-level orchestration** (study plan → study material → practice → test → interview → revision) is missing for all roles.
