...
> **Documentation of every career track** in the repository. Each track maps to a folder and a set of subjects, software, and interview resources.
...
Not sure? Use the decision flow in [GETTING_STARTED.md](GETTING_STARTED.md) and the role mapping in [ROLES.md](ROLES.md).
