...
> **Role documentation.** For each career role: which track it belongs to, which topics to study, and which resources to use.

---

## Role → Track → Topics → Resources
...
For cross-role completeness scores, see the [Role Readiness Matrix](../_SYSTEM/ROLE_READINESS_MATRIX.md) (maintainer-facing).
