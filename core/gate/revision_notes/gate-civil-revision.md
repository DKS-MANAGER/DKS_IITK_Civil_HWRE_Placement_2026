...
> Flashcard-style rapid revision. Priority: `[P0]` Must Memorize, `[P1]` Frequently Used, `[P2]` Useful.
> Primary source: GATE-O-PEDIA Civil Engineering Handbook (Physics Wallah).
...
| Method | Formula |
|--------|---------|
| Rational | Q = CiA/360 (A in ha, i in mm/hr) |
...
| Hydraulic radius vs pipe radius | R = A/P; full pipe R = D/4 |
| Gauge vs absolute pressure | p_abs = p_gauge + p_atm |

---

## 📝 Last Minute Checklist

- [ ] All P0 formulas memorized
