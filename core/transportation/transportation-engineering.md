...
─────────────────────────────────────────────────────────────────────────────────────────────────────
Highway classes       →  Geometric design (IRC)       →  Flexible pavement design     →  SSD formula
Traffic basics        →  Vertical/horizontal curves    →  Rigid pavement design        →  Superelevation calc
Pavement intro        →  Traffic studies & signal      →  Highway capacity analysis    →  Signal timing design
Surveying basics      →  Intersection design           →  Transport planning (4-step)  →  Level of service
```

> **Priority:** `P0 — Must Know` · **Tags:** `CORE CIVIL` `TRANSPORTATION`
...
### A. Basic Concept
1. What are the IRC geometric design standards?
2. Explain the highway pavement design process.
3. What is the difference between flexible and rigid pavements?

### B. WHY Questions
1. **Why** does superelevation increase with design speed?
   - Higher speed requires greater centripetal force; superelevation provides this through gravity component, reducing dependence on lateral friction.

2. **Why** is the K-value used for vertical curve design?
   - K = L/N represents the horizontal distance per unit grade change; it directly relates to sight distance requirements (stopping or passing).

3. **Why** are traffic signals timed with a cycle length?
   - To provide orderly movement through intersections, balance delays across approaches, and coordinate along corridors (green wave).

### D. Comparison
| Concept A | Concept B | Key Difference |
|-----------|-----------|----------------|
| Flexible pavement | Rigid pavement | Asphalt layers vs concrete slab |
| SSD | PSD | Stopping vs passing sight distance |
| IRC 37 | IRC 58 | Flexible vs rigid design codes |
| Summit curve | Valley curve | Convex vs concave vertical alignment |

---

## 🎤 Interview Answer Format

### High-Value Q: "How do you design a flexible pavement?"

**30-second answer:**
"Use IRC:37-2018. Determine traffic in MSA (million standard axles), CBR of subgrade, and design CBR. Layered system: subgrade → subbase → base → binder → surface. Each layer thickness is selected to protect the layer below from fatigue and rutting."

---

## 🔗 Cross-Links

- [`geotechnical.md`](../geotechnical/geotechnical.md) — Subgrade soil properties
- [`structures.md`](../structures/structures.md) — Bridge design
- [`infrastructure-engineering-management.md`](../infrastructure/infrastructure-engineering-management.md) — Project management
- [`transportation-software.md`](transportation-software.md) — Design software
