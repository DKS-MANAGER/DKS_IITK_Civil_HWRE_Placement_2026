...
Interviewers use your self-introduction to assess your **communication clarity**, **relevance to the role**, and **fit with the company**. A clear, forward-looking narrative that ties your background to the role works better than a life-history dump.

---

## The Framework: Present → Past → Future

| Section | What to Cover | Time | Tips |
|---------|---------------|------|------|
| **Present** | Current role/status, degree, key skills being used | ~1 min | Anchor in the most recent, relevant experience |
| **Past** | Background that built your relevant skills (education, projects, internships) | ~1 min | Emphasise civil/HWRE-relevant learning, not everything |
| **Future** | Why this role/company and how you'll contribute | ~1 min | Tie to company values, team needs, your growth goals |
...
- ❌ Starting with personal/family background ("I was born in…").
- ❌ Listing everything you ever did; keep it **role-relevant**.
- ❌ Reciting your CV verbatim — the interviewer can read.
- ❌ Talking only about yourself with no bridge to the company.
- ❌ Being too generic ("I want to learn and grow everywhere").
- ❌ Going over 2–3 minutes.

## Do's

- ✅ Keep it **2–3 minutes** (≈ 250–350 spoken words).
- ✅ Lead with the **most recent, relevant** experience.
- ✅ Mention **2–3 concrete skills** you bring.
- ✅ End with a clear, forward-looking statement about **why this role** and **what you'll contribute**.
- ✅ Practice aloud until conversational, not memorised.
- ✅ Keep a **30-second** "elevator" version ready for networking events.
...
| Checkpoint | Done? |
|------------|-------|
| Present is current & relevant | [ ] |
| Past explains how I got here (2–3 skills) | [ ] |
| Future ties me to *this* role/company with a specific reason | [ ] |
| Mention one quantified achievement | [ ] |
| 2–3 minutes; conversational tone | [ ] |
