# 📅 Non-Core Placement Roadmap

> Flexible preparation plans based on your available time. No mandatory timetables — study according to your schedule and target role.

---

## 1-Day Plan (Last-Minute Survival)
...
- [ ] Sleep well — trust your preparation
...
- [ ] Read your target role overview in depth
- [ ] Study the topic checklist for your role
...
> **Target:** Comprehensive preparation with depth. Adjust pacing to your comfort.

### Week 1: Foundation (Days 1-7)

**Focus:** Business vocabulary, communication, role selection
...
**Focus:** Deep dive into your target role

| Day | Activity | Resource |
|:----|:---------|:---------|
| 8 | Role overview + day-to-day | Your role's overview file |
| 9 | Technical skills for the role | Role-specific topics |
...
**Focus:** Case interviews, guesstimates, role-specific practice
...
**Focus:** Mock interviews, weak area remediation, final preparation
...
- Revisit any weak areas
- Final resume review
- Prepare interview outfit
- Plan logistics (route, timing, documents)

---

## Role-Specific Priority Matrix

Use this to focus your limited time on what matters most for your target role.

### Consulting

| Priority | What to Prepare | Time |
|:---------|:----------------|:-----|
| [P0] | Case frameworks (Profitability, Market Entry, Growth) | 10 hrs |
| [P0] | Structured thinking + synthesis | 5 hrs |
| [P0] | Business fundamentals | 4 hrs |
| [P1] | Market sizing | 3 hrs |
| [P1] | Behavioral (leadership, teamwork) | 3 hrs |
| [P2] | Industry knowledge | 5 hrs |
| [P2] | Guesstimates | 2 hrs |

### Business Analyst

| Priority | What to Prepare | Time |
|:---------|:----------------|:-----|
| [P0] | SQL (joins, aggregations, CTE, windows) | 10 hrs |
| [P0] | Excel (pivots, VLOOKUP, charts) | 4 hrs |
| [P0] | Business fundamentals | 3 hrs |
| [P1] | Case questions (business reasoning) | 4 hrs |
| [P1] | Statistics basics | 3 hrs |
| [P2] | Dashboard interpretation | 2 hrs |

### Data Analyst

| Priority | What to Prepare | Time |
|:---------|:----------------|:-----|
| [P0] | SQL (advanced queries, optimization) | 8 hrs |
| [P0] | Statistics (hypothesis testing, distributions) | 8 hrs |
| [P0] | Python/Pandas | 8 hrs |
| [P1] | A/B testing | 3 hrs |
| [P1] | Data visualization | 3 hrs |
| [P2] | Machine learning basics | 4 hrs |

### Product Manager

| Priority | What to Prepare | Time |
|:---------|:----------------|:-----|
| [P0] | Product sense (design/improve questions) | 8 hrs |
| [P0] | Metrics (engagement, retention, revenue) | 5 hrs |
| [P0] | Prioritization frameworks | 3 hrs |
| [P1] | Strategy (market entry, competitive) | 4 hrs |
| [P1] | Behavioral (leadership, conflict) | 4 hrs |
| [P2] | A/B testing / experimentation | 3 hrs |

### Operations

| Priority | What to Prepare | Time |
|:---------|:----------------|:-----|
| [P0] | Process optimization framework | 5 hrs |
| [P0] | Capacity / bottleneck analysis | 4 hrs |
| [P0] | Quantitative problems | 5 hrs |
| [P1] | Lean / Six Sigma basics | 3 hrs |
| [P1] | Civil-specific operations cases | 3 hrs |
| [P2] | Inventory / scheduling | 3 hrs |

---

## Tips for Flexible Study

- **No strict schedule** — adapt these plans to your energy and availability
- **Focus on your weakest area first** — that's where the most improvement happens
- **Practice out loud** — reading silently is not the same as speaking
- **Quality over quantity** — 2 well-prepared stories beat 10 half-baked ones
- **Review regularly** — spaced repetition beats cramming
- **Use idle time** — listen to business podcasts, read company annual reports
- **Track your progress** — check off completed items, note areas needing more work
