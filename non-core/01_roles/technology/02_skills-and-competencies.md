# 02. Technology & Systems Consulting: Required Skills & Competencies
...
|:---|:---:|:---|:---|
| **Required Skills** | **P0** | High-Level System Design, API Contracts (REST/gRPC), Database Selection (SQL vs NoSQL), Cloud Migration Strategy, Microservices | OA / Technical & Case Rounds |
| **Tooling & Software** | **P0** | System Architecture Diagrams, SQL, Postman / API Testing, Cloud Fundamentals (AWS/GCP) | Live Coding / Technical Round |
