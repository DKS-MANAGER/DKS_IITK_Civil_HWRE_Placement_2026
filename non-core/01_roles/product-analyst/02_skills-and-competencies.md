# 02. Product Analyst: Required Skills & Competencies
...
|:---|:---:|:---|:---|
| **Required Skills** | **P0** | Event Instrumentation Schemas, A/B Testing, Cohort Retention Heatmaps, Funnel Step Telemetry, SQL, Python | OA / Technical & Case Rounds |
| **Tooling & Software** | **P0** | SQL, Amplitude, Mixpanel, Python, Google Analytics 4 | Live Coding / Technical Round |
