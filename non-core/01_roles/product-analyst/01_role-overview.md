# 01. Product Analyst: Placement & Job Guide

> Comprehensive IIT Kanpur placement guide for **Product Analyst** profiles: Target companies, salary benchmarks, hiring roles, eligibility, day-to-day deliverables, and placement preparation roadmap.
...
| Dimension | Details |
|:---|:---|
| **Target Hiring Companies** | Groww, Zepto, CRED, Dream11, Swiggy, Nykaa, InMobi, PhonePe, Meesho |
| **Typical Job Designations** | Product Analyst, Growth Analyst, Experimentation Analyst |
| **Placement CTC Range** | 12 LPA - 24 LPA |
| **Department Eligibility** | B.Tech / M.Tech all branches. Strong SQL, statistics, and product experimentation skills. |
