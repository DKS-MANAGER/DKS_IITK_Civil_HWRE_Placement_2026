# 02. Supply Chain Management: Required Skills & Competencies
...
|:---|:---:|:---|:---|
| **Required Skills** | **P0** | Bullwhip Effect Mitigation, Safety Stock & Reorder Points, Multi-Echelon Inventory Optimization, S&OP Forecasting, Network Routing | OA / Technical & Case Rounds |
| **Tooling & Software** | **P0** | Excel Solver, Linear Programming (Python PuLP), SAP / Oracle SCM | Live Coding / Technical Round |
