# Program Management (PgM) Placement Track
...
- **Typical CTC Range**: 13 LPA - 28 LPA
- **Department Eligibility**: B.Tech / M.Tech engineering branches.
- **Core Skills Tested**: Critical Path Method (CPM/PERT), Schedule Variance (SV), Cost Variance (CV), RACI Matrices, RAID Logs, Cross-Functional Governance
