# 02. Risk Management & Analytics: Required Skills & Competencies
...
|:---|:---:|:---|:---|
| **Required Skills** | **P0** | Credit Scorecards (WOE / Information Value), Value at Risk (VaR), Probability of Default (PD), Stress Testing, SQL, Python | OA / Technical & Case Rounds |
| **Tooling & Software** | **P0** | Python, SQL, R, SAS concepts, Risk Simulation Engines | Live Coding / Technical Round |
