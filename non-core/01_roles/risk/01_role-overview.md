# 01. Risk Management & Analytics: Placement & Job Guide

> Comprehensive IIT Kanpur placement guide for **Risk Management & Analytics** profiles: Target companies, salary benchmarks, hiring roles, eligibility, day-to-day deliverables, and placement preparation roadmap.
...
| Dimension | Details |
|:---|:---|
| **Target Hiring Companies** | American Express, Mastercard, Visa, Standard Chartered, HSBC, Moody's Analytics, CRISIL, Barclays |
| **Typical Job Designations** | Risk Analyst, Credit Risk Associate, Quantitative Risk Specialist |
| **Placement CTC Range** | 11 LPA - 24 LPA |
| **Department Eligibility** | B.Tech / M.Tech engineering branches. Strong probability and quantitative modeling foundation. |
