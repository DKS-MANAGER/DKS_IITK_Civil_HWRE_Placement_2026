# 01. Business Operations (BizOps): Placement & Job Guide

> Comprehensive IIT Kanpur placement guide for **Business Operations (BizOps)** profiles: Target companies, salary benchmarks, hiring roles, eligibility, day-to-day deliverables, and placement preparation roadmap.
...
| Dimension | Details |
|:---|:---|
| **Target Hiring Companies** | Flipkart, Uber, Ola, Delhivery, Zepto, Blinkit, Urban Company, Swiggy, Amazon |
| **Typical Job Designations** | BizOps Associate, Strategy & Operations Associate, Program Analyst |
| **Placement CTC Range** | 11 LPA - 22 LPA |
| **Department Eligibility** | B.Tech / M.Tech all branches. |
