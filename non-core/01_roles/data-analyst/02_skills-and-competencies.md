# 02. Data Analyst: Required Skills & Competencies
...
|:---|:---:|:---|:---|
| **Required Skills** | **P0** | Relational Databases, Advanced SQL, Data Cleaning & Preprocessing, Exploratory Data Analysis (EDA), Dashboard Automation (Tableau/Power BI), Statistical Inference | OA / Technical & Case Rounds |
| **Tooling & Software** | **P0** | PostgreSQL / MySQL / Snowflake, Python (Pandas, NumPy, Matplotlib, Seaborn), Power BI / Tableau, Excel | Live Coding / Technical Round |
