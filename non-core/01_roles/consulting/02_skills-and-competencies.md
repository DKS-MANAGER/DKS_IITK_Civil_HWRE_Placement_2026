# 02. Management Consulting: Required Skills & Competencies
...
|:---|:---:|:---|:---|
| **Required Skills** | **P0** | MECE Structuring, Hypothesis-Driven Problem Solving, Issue Tree Construction, Fast Mental Math, Business Acumen, Top-Down Communication (Pyramid Principle), Executive Synthesis | OA / Technical & Case Rounds |
| **Tooling & Software** | **P0** | Advanced Excel Modeling, PowerPoint (Think-Cell), Mental Arithmetic, Framework Synthesis | Live Coding / Technical Round |
