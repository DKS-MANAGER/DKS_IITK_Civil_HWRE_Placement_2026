# Management Consulting Placement Track

> Placement-focused preparation curriculum for IIT Kanpur students targeting **Management Consulting** roles at top recruiting firms.

---

## 📋 Role Snapshot
- **Target Companies**: McKinsey & Company, Boston Consulting Group (BCG), Bain & Company, Kearney, Strategy&, Oliver Wyman, Arthur D. Little, EY-Parthenon, PwC Strategy, Alvarez & Marsal, Roland Berger, ZS Associates
- **Typical CTC Range**: 15 LPA - 35 LPA (Tier-1 MBB / Strategy firms)
- **Department Eligibility**: B.Tech / M.Tech / Dual Degree (Open to all branches). High emphasis on overall Spike (CPI >= 8.0 preferred for MBB shortlisting, PORs, case competitions, academic excellence).
- **Core Skills Tested**: MECE Structuring, Hypothesis-Driven Problem Solving, Issue Tree Construction, Fast Mental Math, Business Acumen, Top-Down Communication (Pyramid Principle), Executive Synthesis
