# 02. Finance & FinTech: Required Skills & Competencies
...
|:---|:---:|:---|:---|
| **Required Skills** | **P0** | 3-Statement Financial Modeling, Discounted Cash Flow (DCF), Valuation Multiples (EV/EBITDA, P/E), Working Capital Dynamics, Financial Ratios, Excel | OA / Technical & Case Rounds |
| **Tooling & Software** | **P0** | Advanced Excel Financial Modeling, Python for Financial Analytics, DCF Templates | Live Coding / Technical Round |
