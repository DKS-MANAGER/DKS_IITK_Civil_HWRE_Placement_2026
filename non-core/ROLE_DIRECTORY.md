...
```mermaid
graph TD
    A[Civil / HWRE Background] --> B[Strategic & Business]
    A --> C[Quantitative & Analytics]
    A --> D[Operations & Execution]
    
    B --> B1[Consulting]
    B --> B2[Product Management]
    B --> B3[Corporate Strategy]
    
    C --> C1[Analytics & Data Science]
    C --> C2[Finance & Risk]
    C --> C3[Product Analyst]
    
    D --> D1[Business Operations]
    D --> D2[Supply Chain]
    D --> D3[Program Management]
```
