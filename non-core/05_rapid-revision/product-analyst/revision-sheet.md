...
> Canonical, condensed 60/30/10/5-minute emergency revision sheet for Product Analyst interviews and Online Assessments.
...
### 1. Core Product Analyst Diagnostic Tree
...
|:---|:---|:---|
| **Core Operational Metrics** | P&L Driver Decomposition | Feature adoption funnels, behavioral clustering, A/B test telemetry, engagement metrics. |
...
1. **Q**: *How do you evaluate performance in Product Analyst?* -> **A**: Deconstruct core North Star metric into operational leading and lagging indicators.
...
- [ ] Civil-to-Product Analyst project narrative rehearsed.

### 🗣️ The 60-Second "Why Product Analyst from Civil?" Pitch
> *"My Civil Engineering background at IIT Kanpur grounded me in rigorous quantitative problem solving, data modeling under physical constraints, and analyzing complex networks. I am applying this structured, analytical discipline to high-velocity decision-making in Product Analyst."*
