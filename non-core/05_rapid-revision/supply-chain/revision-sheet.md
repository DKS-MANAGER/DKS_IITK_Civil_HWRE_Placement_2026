# Supply Chain Management — Rapid Revision Sheet

> Canonical, condensed 60/30/10/5-minute emergency revision sheet for Supply Chain Management interviews and Online Assessments.
...
### 1. Core Supply Chain Management Diagnostic Tree
...
|:---|:---|:---|
| **Core Operational Metrics** | P&L Driver Decomposition | Bullwhip effect, safety stock math, multi-echelon logistics, dark store distribution. |
...
- Applying theoretical concepts without anchoring in commercial business P&L.
- Neglecting stakeholder alignment and cross-functional implementation constraints.

### ⚡ Rapid Practice Questions & Answers
1. **Q**: *How do you evaluate performance in Supply Chain Management?* -> **A**: Deconstruct core North Star metric into operational leading and lagging indicators.
...
- [ ] Civil-to-Supply Chain Management project narrative rehearsed.

### 🗣️ The 60-Second "Why Supply Chain Management from Civil?" Pitch
> *"My Civil Engineering background at IIT Kanpur grounded me in rigorous quantitative problem solving, data modeling under physical constraints, and analyzing complex networks. I am applying this structured, analytical discipline to high-velocity decision-making in Supply Chain Management."*
