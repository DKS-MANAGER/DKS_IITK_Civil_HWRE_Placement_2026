...
**Finance:**
→ [Finance Overview](../../01_roles/finance/01_role-overview.md) — Complete preparation system
→ [Role Study Plan](../../01_roles/finance/08_role-study-plan.md) — Structured study plan

**Related:**
→ [Risk Rapid Revision](../../01_roles/risk/09_rapid-revision.md) — Risk management formulas
