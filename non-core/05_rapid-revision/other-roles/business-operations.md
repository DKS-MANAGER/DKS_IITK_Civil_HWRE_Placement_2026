...
**BizOps:**
→ [BizOps Overview](../../01_roles/business-operations/01_role-overview.md) — Complete preparation system
→ [Role Study Plan](../../01_roles/business-operations/08_role-study-plan.md) — Structured study plan

**Related:**
→ [Operations Overview](../operations/../../01_roles/operations/01_role-overview.md) — Operations role
→ [Strategy Overview](../strategy/../../01_roles/strategy/01_role-overview.md) — Strategy role
