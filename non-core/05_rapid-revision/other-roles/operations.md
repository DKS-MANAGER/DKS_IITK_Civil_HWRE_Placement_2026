...
**Operations:**
→ [Operations Overview](../../01_roles/operations/01_role-overview.md) — Complete preparation system
→ [Role Study Plan](../../01_roles/operations/08_role-study-plan.md) — Structured study plan

**Related:**
→ [Supply Chain Overview](../supply-chain/../../01_roles/supply-chain/01_role-overview.md) — Supply chain role
→ [Program Mgmt Overview](../program-management/../../01_roles/program-management/01_role-overview.md) — PM role
